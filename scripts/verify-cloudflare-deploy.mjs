...
if (config.assets && JSON.stringify(config.assets.run_worker_first) !== JSON.stringify(["/api/*"])) {
...
if (typeof redirect.configPath !== "string" || !redirect.configPath.includes(".output/server/wrangler.json")) {
